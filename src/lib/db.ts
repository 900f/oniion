...
export async function runMigrations() {
  ...
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS card_image_url TEXT`);
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS card_position VARCHAR(20) DEFAULT 'top'`);
  ...
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS card_tilt BOOLEAN DEFAULT true`);
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS show_views BOOLEAN DEFAULT true`);
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS show_id BOOLEAN DEFAULT true`);
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS show_music BOOLEAN DEFAULT true`);
  await run(`ALTER TABLE profiles ADD COLUMN IF NOT EXISTS name_font VARCHAR(32) DEFAULT 'orbitron'`);
}
