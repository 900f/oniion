...
export default function RegisterPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ position: 'fixed', top: '30%', left: '30%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(168,85,247,0.08) 0%, transparent 70%)', filter: 'blur(60px)', pointerEvents: 'none' }} />
      ...
      <div className="glass" style={{ width: '100%', maxWidth: 420, padding: '48px 40px', animation: 'fadeInUp 0.5s ease' }}>
        ...
        <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 28, marginBottom: 8, letterSpacing: '-1px' }}>Create account</h1>
        <p style={{ color: '#666', fontSize: 14, marginBottom: 32 }}>Your profile will be at oniion.cc/<span style={{ color: '#a855f7' }}>{username || 'yourname'}</span></p>
